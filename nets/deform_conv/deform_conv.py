...
import torch
torch.ops.load_library("nets/deform_conv/dcn_cpp_plugin/build/libdcn_v2_cuda_forward_v2.so")
from torch import nn
from torch.autograd import Function
from torch.autograd.function import once_differentiable
from torch.nn.modules.utils import _pair

import nets.deform_conv._ext as _backend
...
class DCNv2(nn.Module):
    ...
    def forward(self, input, offset, mask):
        ...
        return _backend.dcn_v2_forward(
            input,
            self.weight,
            self.bias,
            offset,
...
class ModulatedDeformConv(DCNv2):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        super(ModulatedDeformConv, self).__init__(in_channels, out_channels, kernel_size, stride, padding, dilation, groups, deformable_groups)

        channels_ = self.deformable_groups * 3 * self.kernel_size[0] * self.kernel_size[1]
        self.reset_parameters()

    def forward(self, input, offset, mask):
        return torch.ops.my_ops.dcn_v2_cuda_forward_v2(input, self.weight, self.bias,
                                    offset, mask,
